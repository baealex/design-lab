...
Each page keeps its HTML, styles, and scripts in one file. Shared markup is assembled from layouts and partials at build time, while the development server rebuilds and refreshes only the affected pages.
